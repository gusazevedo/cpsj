        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              O Centro Pastoral São José será construído em uma de nossas 10 capelas, criando um espaço dedicado ao acolhimento, formação e encontro da nossa comunidade paroquial.
            </p>
          </div>
